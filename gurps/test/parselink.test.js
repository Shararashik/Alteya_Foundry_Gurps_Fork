...
describe('parseLink', () => {
    ...
    describe('Modifiers', () => {
        ...
        test('#> !@actorid@ -4 the GM hates me & IQ-2', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='-4 the GM hates me & IQ-2'>&minus;4 the GM hates me</span>"));
        });
        test('#> !@actorid@ -2 for Stun &+1 for Luck&-3 My GM hates me', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='-2 for Stun &+1 for Luck&-3 My GM hates me'>&minus;2 for Stun & +1 for Luck & -3 My GM hates me</span>"));
        });
        test('#> +@margin For some reason & -1 for stupidity', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='+@margin For some reason & -1 for stupidity'>+@margin For some reason & -1 for stupidity</span>"));
        });
        test('#> +@margin For some reason & ST12', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='+@margin For some reason & ST12'>+@margin For some reason</span>"));
        });
        test('#> +@margin', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
    ...
    describe('Drag and Drop', () => {
        test('#> JournalEntry[1234]{some text}', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='JournalEntry[1234]{some text}'>{some text}</span>"));
        });
    ...
    describe('Attribute', () => {
        ...
        test('#> Fright Check -2 for Fear', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Fright Check -2 for Fear'>Fright Check -2 for Fear</span>"));
        });
        test('#> Fright Check14', () => {
            let result = parselink(input);
            expect(result.action).toEqual({
        ...
        test('#> ST12 +2 Some description', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='ST12 +2 Some description'>ST12 +2 Some description</span>"));
        });
        test('(Russian DX) #> ЛВ', () => {
            const result = parselink(input);
        ...
        test('#> Parry:Broadsword +2 Description', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Parry:Broadsword +2 Description'>Parry:Broadsword +2 Description</span>"));
        });
        ...
        test('#> Parry:Wizard*s*Staff +2 Description', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Parry:Wizard*s*Staff +2 Description'>Parry:Wizard*s*Staff +2 Description</span>"));
        });
        test('#> HT | DX', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
    ...
    test('#> CR: 9 to resist temptation', () => {
        ...
        expect(result.text).toEqual(expect.stringContaining("data-otf='CR: 9 to resist temptation'>CR: 9 to resist temptation</span>"));
    });
    test('#> CR: 15', () => {
        const result = parselink(input);
        expect(result.action).toEqual({
    ...
    describe('Skill-Spell', () => {
        ...
        test('#> S:Stealth Comment', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='S:Stealth Comment'><b>S:</b>Stealth Comment</span>"));
        });
        test('#> S:Savoir-faire -3 description | something else', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='S:Savoir-faire -3 description | something else'><b>S:</b>Savoir-faire -3 description</span>"));
        });
        test('#> S:Acrobatics-6', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
        ...
        test('#> Sp:"Bigby\'s Crushing Hand" +1 Description', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Sp:\"Bigby's Crushing Hand\" +1 Description'><b>Sp:</b>Bigby's Crushing Hand +1 Description</span>"));
        });
        test("#> Sp:'Bigbys Crushing Hand' +1 Description", () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Sp:'Bigbys Crushing Hand' +1 Description'><b>Sp:</b>Bigbys Crushing Hand +1 Description</span>"));
        });
        ...
        test("#> Sp:'' +1 Description", () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Sp:'' +1 Description'><b>Sp:</b>+1 Description</span>"));
        });
        ...
        test('#> Sk:Stealth +3 (Based: IQ) Comment this', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Sk:Stealth +3 (Based: IQ) Comment this'><b>Sk:</b>Stealth +3 Comment this (Based:IQ)</span>"));
        });
        test('#> Sk:Stealth +3 (Based: ZX) Comment this', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Sk:Stealth +3 (Based: ZX) Comment this'><b>Sk:</b>Stealth +3 Comment this</span>"));
        });
        test('#> Sk:Stealth +3 *Costs 2 HP', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Sk:Stealth +3 *Costs 2 HP'><b>Sk:</b>Stealth *Costs 2 HP +3</span>"));
        });
        test('#> Sk:Stealth +3 * Per 2HP', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='Sk:Stealth +3 * Per 2HP'><b>Sk:</b>Stealth * Per 2HP +3</span>"));
        });
        test('#> Sk:Stealth -2 for armor ? "Sneaky" , "Alarm!"', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining('data-otf=\'Sk:Stealth -2 for armor ? "Sneaky" , "Alarm!"\'><b>Sk:</b>Stealth -2 for armor</span>'));
        });
        test('#> Sk:Stealth -2 for armor ? "Sneaky" : "Alarm!"', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
        ...
        test('#> S:Stealth +@margin for Spell', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='S:Stealth +@margin for Spell'><b>S:</b>Stealth +@margin for Spell</span>"));
        });
        test('#> S:Stealth+@margin for Spell', () => {
            // Is there a way to get the test name?
            const result = parselink(input);
        ...
        test('#> S:Savoir-faire -3 description | IQ -6 default', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='S:Savoir-faire -3 description | IQ -6 default'><b>S:</b>Savoir-faire -3 description | IQ -6 default</span>"));
        });
        test('#> S:Acrobatics | DX-6', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='S:Acrobatics | DX-6'><b>S:</b>Acrobatics | DX -6</span>"));
        });
    });
    describe('Melee/Ranged/Attack/Damage/Block/Parry', () => {
        ...
        test('#> M:Broadsword (Swung)', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='M:Broadsword (Swung)'><b>M:</b>Broadsword (Swung)</span>"));
        });
        test('#> A:Broadsword', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
        ...
        test('#> A:Broadsword *Per 1FP', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:Broadsword *Per 1FP'><b>A:</b>Broadsword *Per 1FP</span>"));
        });
        test('#> A:Broadsword * Costs 1 HP', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:Broadsword * Costs 1 HP'><b>A:</b>Broadsword * Costs 1 HP</span>"));
        });
        test('#> A:Broadsword * Per 1 tr0000', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:Broadsword * Per 1 tr0000'><b>A:</b>Broadsword * Per 1 tr0000</span>"));
        });
        test('#> A:Broadsword *Costs 1 tr(Mana)', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:Broadsword *Costs 1 tr(Mana)'><b>A:</b>Broadsword *Costs 1 tr(Mana)</span>"));
        });
        test('#> A:Broadsword *Costs 1 tr("Control Points")', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining('data-otf=\'A:Broadsword *Costs 1 tr("Control Points")\'><b>A:</b>Broadsword *Costs 1 tr("Control Points")</span> "Control Points")'));
        });
        test('#> A:Broadsword *Costs 1 tr(Control Points)', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:Broadsword *Costs 1 tr(Control Points)'><b>A:</b>Broadsword *Costs 1 tr(Control Points)</span> Points)"));
        });
        test('#> A:Broadsword *Costs 1 tr(Control*Points)', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
        ...
        test('#> A:Broadsword-2 stunned', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:Broadsword-2 stunned'><b>A:</b>Broadsword-2 stunned</span>"));
        });
        test('#> A:Broadsword -2 stunned', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
        ...
        test('#> A:Throwing*Axe -2 stunned', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:Throwing*Axe -2 stunned'><b>A:</b>Throwing*Axe-2 stunned</span>"));
        });
        test('#> R:"Throwing Axe" -2 stunned', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining('data-otf=\'R:"Throwing Axe" -2 stunned\'><b>R:</b>Throwing Axe-2 stunned</span>'));
        });
        test('#> R:"Throwing Axe" +@margin', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining('data-otf=\'R:"Throwing Axe" +@margin\'><b>R:</b>Throwing Axe +@margin</span>'));
        });
        test('#> R:"Throwing Axe" +@margin Serendipity', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining('data-otf=\'R:"Throwing Axe" +@margin Serendipity\'><b>R:</b>Throwing Axe +@margin Serendipity</span>'));
        });
        ...
        test('#> D:"Throwing Axe"-2 stunned', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining('data-otf=\'D:"Throwing Axe"-2 stunned\'><b>D:</b>Throwing Axe-2 stunned</span>'));
        });
        test('#> P:Broadsword', () => {
            const result = parselink(input);
            expect(result.action).toEqual({
        ...
        test('#> A:Throwing Axe -2 stunned', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:Throwing Axe -2 stunned'><b>A:</b>Throwing</span> Axe -2 stunned"));
        });
        test('#> A:"Mage\'s Staff" +1 magic attack', () => {
            ...
            expect(result.text).toEqual(expect.stringContaining("data-otf='A:\"Mage's Staff\" +1 magic attack'><b>A:</b>Mage's Staff+1 magic attack</span>"));
        });
        test("#> A:'Sword \"Saethor\\'s Bane\"'", () => {
            ...
            expect(result.text).toEqual(expect.stringContaining('data-otf=\'A:\'Sword "Saethor*s Bane"\'\'><b>A:</b>Sword "Saethor*s Bane"</span>'));
        });
    });
    ...
    test('#> Sk:Scrounging | Per-4', () => {
        ...
        expect(result.text).toEqual(expect.stringContaining("data-otf='Sk:Scrounging | Per-4'><b>Sk:</b>Scrounging | Per -4</span>"));
    });
});
